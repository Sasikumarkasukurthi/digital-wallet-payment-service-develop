...
export CONTAINER="digital-wallet-payment-service"   # container name set from helm chart
...
case $BUILD_PROFILE in
     "alpha")
          setImage https://rancher2.tecnotree.com/v3 c-2cglh:p-vqggq dclm digital-wallet-payment-service
		  ;;
     "beta")
          setImage https://rancher2.tecnotree.com/v3 c-2cglh:p-6fcjz mmp-dclm digital-wallet-payment-service
          #setImage https://dev-rancher.tecnotree.com/v3 c-vxw2t:p-82rjc mdp-dclm-ns digital-wallet-wallet-ui
          ;;
     "rc")
          #setImage https://rancher2.tecnotree.com/v3 c-2cglh:p-6fcjz  mmp-dclm digital-wallet-wallet-ui
          ;;
	   *)
